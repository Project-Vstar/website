    ...
    const genmates = talentsData.talents.filter(
        (t) =>
            Array.isArray(t.groups)
                ? t.groups.includes("vinfernia") && t.name !== gomifuyuData.name
                : t.group === "vinfernia" && t.name !== gomifuyuData.name
    );
            ...
            <main className="flex-grow pt-0">
                ...
                <div className="relative" style={{ backgroundColor: themeColors.background }}>
                    ...
                    <div
                        ...
                        style={{ background: `linear-gradient(to bottom, rgba(16,12,8,0.7) 50%, rgba(16,12,8,0.9) 100%)` }}
                    />
                    <div
                        className="absolute inset-0 z-0 pointer-events-none"
